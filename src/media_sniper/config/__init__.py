...
_external_files = [Path(sys.prefix, "etc", "media_sniper", "settings.yml")]


settings = Dynaconf(
    # Set env `MEDIA_SNIPER_FOO='bar'`，use `settings.FOO` .
    envvar_prefix="MEDIA_SNIPER",
